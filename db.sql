...
/*Table structure for table `customer_notifications_table` */

DROP TABLE IF EXISTS `customer_notifications_table`;

CREATE TABLE `customer_notifications_table` (
  `customerNotificationId` int(6) NOT NULL AUTO_INCREMENT,
  `customerId` int(6) DEFAULT NULL,
  `customerNotificationMessage` text,
  `customerNotificationDateTime` varchar(60) DEFAULT NULL,
  `customerNotificationIsRead` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`customerNotificationId`),
  KEY `FK_notifications_table` (`customerId`),
  CONSTRAINT `FK_customer_notifications_table` FOREIGN KEY (`customerId`) REFERENCES `customers_table` (`customerId`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `customer_notifications_table` */
...
insert  into `order_details_table`(`orderDetailId`,`productVariationId`,`orderId`,`quantity`,`price`) values (7,21,16,1,199),(8,40,16,1,299),(9,9,17,2,159),(10,35,18,1,398),(11,9,19,2,159),(15,46,20,13,1455),(16,9,21,1,159),(17,39,21,1,299),(18,42,21,2,251.75),(19,44,22,1,251.75),(20,43,23,1,251.75);
...
insert  into `orders_table`(`orderId`,`orderShippingArrivalOrPickupDate`,`orderPlacedDate`,`orderShippingAddress`,`orderType`,`orderShipFirstName`,`orderShipLastName`,`orderShipEmail`,`orderShipPhoneNumber`,`orderStatus`,`orderTotalAmount`,`orderShippingFee`,`customerId`,`orderDeliveryMethod`,`billingAddress`,`billingFirstName`,`billingLastName`,`billingEmail`,`billingPhoneNumber`,`orderModeOfPayment`,`orderRemarks`,`orderPaymentStatus`) values (16,NULL,'2019-04-05 11:25:16','72, mabini street, tacurong city, sutltan kudarat','Online','Cesar','Santiago','customer@gmail.com','09367489655','Confirmed',498,NULL,6,'Shipping','72, mabini street, tacurong city, sutltan kudarat','Cesar','Santiago','customer@gmail.com','09367489655','Remittance','tae1','Unpaid'),(17,NULL,'2019-04-05 12:05:48','72, mabini street, tacurong city, sutltan kudarat','Online','Cesar','Santiago','customer@gmail.com','09367489655','Finished',318,NULL,6,'Shipping','72, mabini street, tacurong city, sutltan kudarat','Cesar','Santiago','customer@gmail.com','09367489655','Remittance','tasdasd','Paid'),(18,'2019-04-18','2019-04-05 15:27:28',NULL,'Online',NULL,NULL,NULL,NULL,'Cancelled',398,NULL,6,'Pick Up','72, mabini street, tacurong city, sutltan kudarat','Cesar','Santiago','customer@gmail.com','09367489655','Walk In',NULL,'Unpaid'),(19,'2019-04-12','2019-04-05 15:58:10',NULL,'Online',NULL,NULL,NULL,NULL,'Finished',318,NULL,6,'Pick Up','72, mabini street, tacurong city, sutltan kudarat','Cesar','Santiago','customer@gmail.com','09367489655','Remittance','testing','Paid'),(20,'2019-04-18','2019-04-06 15:53:34',NULL,'Online',NULL,NULL,NULL,NULL,'Confirmed',18915,NULL,6,'Pick Up','72, mabini street, tacurong city, sutltan kudarat','Cesar','Santiago','customer@gmail.com','09367489655','Walk In',NULL,'Unpaid'),(21,NULL,'2019-04-06 18:59:59','72, mabini street, tacurong city, sutltan kudarat','Online','Cesar','Santiago','customer@gmail.com','09367489655','Pending Approval',961.5,NULL,6,'Shipping','72, mabini street, tacurong city, sutltan kudarat','Cesar','Santiago','customer@gmail.com','09367489655','Walk In',NULL,'Unpaid'),(22,NULL,'2019-04-06 19:06:38','72, mabini street, tacurong city, sutltan kudarat','Online','Cesar','Santiago','customer@gmail.com','09367489655','Finished',251.75,NULL,6,'Shipping','72, mabini street, tacurong city, sutltan kudarat','Cesar','Santiago','customer@gmail.com','09367489655','Remittance',NULL,'Paid'),(23,'2019-04-10','2019-04-06 22:55:00',NULL,'Online',NULL,NULL,NULL,NULL,'Confirmed',251.75,NULL,6,'Pick Up','72, mabini street, tacurong city, sutltan kudarat','Cesar','Santiago','customer@gmail.com','09367489655','Remittance',NULL,'Unpaid');
...
/*Table structure for table `user_notifications_table` */

DROP TABLE IF EXISTS `user_notifications_table`;

CREATE TABLE `user_notifications_table` (
  `userNotificationId` int(6) DEFAULT NULL,
  `userId` int(6) DEFAULT NULL,
  `userNotificationMessage` text,
  `userNotificationDateTime` datetime DEFAULT NULL,
  `userNotificationIsRead` tinyint(1) DEFAULT NULL,
  KEY `FK_user_notifications_table` (`userId`),
  CONSTRAINT `FK_user_notifications_table` FOREIGN KEY (`userId`) REFERENCES `users_table` (`userId`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `user_notifications_table` */
...
insert  into `users_table`(`userId`,`userName`,`userPassword`,`userLevel`,`isDeleted`,`fullName`) values (1,'admin','21232f297a57a5a743894a0e4a801fc3',1,0,'Admin Name'),(2,'user1','24c9e15e52afc47c225b757e7bee1f9d',2,0,'user1'),(3,'user2','7e58d63b60197ceb55a1c487989a3720',2,0,'user2'),(4,'user3','92877af70a45fd6a2ed7fe81e1236b78',2,0,'user3'),(5,'1','c4ca4238a0b923820dcc509a6f75849b',2,1,'1');
