...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Add Administrator</h3>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                	...
                	<form autocomplete="off" class="form-material m-t-40" method="POST" action="controller.php?from=add-administrator">

                        <div class="row">
                        	<div class="col-md-12">
                        		<div class="form-group">
		                            <label>Email *</label>
		                            <input type="email" class="form-control form-control-line" required="" name="administratorEmail"> 
		                        </div>
                        	</div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control form-control-line" required="" name="confirmPassword"> 
                                </div>
                            </div>
                        </div>                         
