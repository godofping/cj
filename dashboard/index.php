...
if (isset($_GET['s'])) {
    ...
    $what = $s[1];
    $administratorEmail = $s[2];


    if ($timeNow > ($timeFromEmail + 600)) {
        $_SESSION['toast'] = 'reset-failed';
    }
    elseif ($what != 'administrator' or count($s) != 3) {
        ...
        $administratorEmail = $db->escapeString($administratorEmail);
        $administratorUserPassword = $db->escapeString(md5('1234'));
...
<body>
            ...
            <div class="login-box card">
                <div class="card-body">
                    ...
                    <form class="form-horizontal form-material" id="loginform" action="controller.php?from=login" method="POST" autocomplete="off">
                        ...
                        <h3 class="box-title m-b-20">Administrator Login Form</h3>
                    ...
                    <form class="form-horizontal form-material" id="recoverform" action="controller.php?from=forgot-password" method="POST" autocomplete="off">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" type="email" name="administratorEmail" required="" placeholder="Email">
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        <?php if (isset($_SESSION['toast']) and $_SESSION['toast'] == 'administrator-account-blocked'): ?>
            $.toast({
              heading: 'LOGIN FAILED',
