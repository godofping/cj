...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">List of Stock-out</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Reports</a></li>
            <!-- <li class="breadcrumb-item"></li> -->
            <li class="breadcrumb-item active">List of Stock-out</li>
        </ol>
    </div>
...
<script type="text/javascript">
    var title = "List of Stock-out (<?php echo date('F d, Y') ?>)";
    var dataTable = $('#datable').DataTable({
        ...
        "ajax": {
                    "type": 'POST',
                    "url": 'load-list-of-stock-out.php',
