...
CREATE TABLE `notifications_table` (
  ...
  KEY `FK_notifications_table1` (`userId`),
  KEY `FK_notifications_table12` (`orderId`),
  CONSTRAINT `FK_notifications_table` FOREIGN KEY (`customerId`) REFERENCES `customers_table` (`customerId`),
  CONSTRAINT `FK_notifications_table1` FOREIGN KEY (`userId`) REFERENCES `users_table` (`userId`),
  CONSTRAINT `FK_notifications_table12` FOREIGN KEY (`orderId`) REFERENCES `orders_table` (`orderId`)
...
insert  into `order_details_table`(`orderDetailId`,`productVariationId`,`orderId`,`quantity`,`price`) values (7,21,16,1,199),(8,40,16,1,299),(9,9,17,2,159),(10,35,18,1,398),(11,9,19,2,159),(15,46,20,13,1455),(16,9,21,1,159),(17,39,21,1,299),(18,42,21,2,251.75),(19,44,22,1,251.75),(20,43,23,1,251.75),(21,22,24,1,199),(22,27,25,2,149);
...
insert  into `orders_table`(`orderId`,`orderPickupDate`,`orderPlacedDate`,`orderShippingAddress`,`orderType`,`orderShipFirstName`,`orderShipLastName`,`orderShipEmail`,`orderShipPhoneNumber`,`orderStatus`,`orderTotalAmount`,`orderShippingFee`,`customerId`,`orderDeliveryMethod`,`billingAddress`,`billingFirstName`,`billingLastName`,`billingEmail`,`billingPhoneNumber`,`orderModeOfPayment`,`orderRemarks`,`orderPaymentStatus`,`orderIsReschedule`) values (16,NULL,'2019-04-05 11:25:16','72, mabini street, tacurong city, sutltan kudarat','Online','Cesar','Santiago','customer@gmail.com','09367489655','Confirmed',498,NULL,6,'Shipping','72, mabini street, tacurong city, sutltan kudarat','Cesar','Santiago','customer@gmail.com','09367489655','Remittance','tae1','Unpaid',NULL),(17,NULL,'2019-04-05 12:05:48','72, mabini street, tacurong city, sutltan kudarat','Online','Cesar','Santiago','customer@gmail.com','09367489655','Finished',318,NULL,6,'Shipping','72, mabini street, tacurong city, sutltan kudarat','Cesar','Santiago','customer@gmail.com','09367489655','Remittance','tasdasd','Paid',NULL),(18,'2019-04-18','2019-04-05 15:27:28',NULL,'Online',NULL,NULL,NULL,NULL,'Cancelled',398,NULL,6,'Pick Up','72, mabini street, tacurong city, sutltan kudarat','Cesar','Santiago','customer@gmail.com','09367489655','Walk In',NULL,'Unpaid',NULL),(19,'2019-04-12','2019-04-05 15:58:10',NULL,'Online',NULL,NULL,NULL,NULL,'Finished',318,NULL,6,'Pick Up','72, mabini street, tacurong city, sutltan kudarat','Cesar','Santiago','customer@gmail.com','09367489655','Remittance','testing','Paid',NULL),(20,'2019-04-18','2019-04-06 15:53:34',NULL,'Online',NULL,NULL,NULL,NULL,'Confirmed',18915,NULL,6,'Pick Up','72, mabini street, tacurong city, sutltan kudarat','Cesar','Santiago','customer@gmail.com','09367489655','Walk In',NULL,'Unpaid',NULL),(21,NULL,'2019-04-06 18:59:59','72, mabini street, tacurong city, sutltan kudarat','Online','Cesar','Santiago','customer@gmail.com','09367489655','Pending Approval',961.5,NULL,6,'Shipping','72, mabini street, tacurong city, sutltan kudarat','Cesar','Santiago','customer@gmail.com','09367489655','Walk In',NULL,'Unpaid',NULL),(22,NULL,'2019-04-06 19:06:38','72, mabini street, tacurong city, sutltan kudarat','Online','Cesar','Santiago','customer@gmail.com','09367489655','Finished',251.75,NULL,6,'Shipping','72, mabini street, tacurong city, sutltan kudarat','Cesar','Santiago','customer@gmail.com','09367489655','Remittance',NULL,'Paid',NULL),(23,'2019-04-10','2019-04-06 22:55:00',NULL,'Online',NULL,NULL,NULL,NULL,'Confirmed',251.75,NULL,6,'Pick Up','72, mabini street, tacurong city, sutltan kudarat','Cesar','Santiago','customer@gmail.com','09367489655','Remittance',NULL,'Unpaid',NULL),(24,'2019-04-08','2019-04-07 09:25:48',NULL,'Online',NULL,NULL,NULL,NULL,'Finished',199,NULL,6,'Pick Up','72, mabini street, tacurong city, sutltan kudarat','Cesar','Santiago','customer@gmail.com','09367489655','Walk In',NULL,'Paid',2),(25,'2019-04-10','2019-04-07 10:26:06',NULL,'Online',NULL,NULL,NULL,NULL,'Finished',298,NULL,6,'Pick Up','72, mabini street, tacurong city, sutltan kudarat','Cesar','Santiago','customer@gmail.com','09367489655','Walk In',NULL,'Paid',2);
