...
<head>
    ...
    <meta name="description" content="CJ Ashley Fashion Hub">
    <meta name="author" content="r.x">
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="etc/logo.jpg">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        <!-- Logo icon --><b>
                            <img src="etc/logo.jpg" width="55" alt="homepage1" class="dark-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text --><span>
                         <!-- dark Logo text -->
                         <img src="etc/dashboard.png" width="150" alt="homepage" class="dark-logo" />
                      </span> </a>
                </div>
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="assets/images/users/settings.png" alt="user" class="profile-pic" /></a>
