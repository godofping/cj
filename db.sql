...
insert  into `user_feedbacks_table`(`userFeedbackId`,`userId`,`userFeedback`,`userFeedbackDate`,`userFeedbackStatus`) values (4,6,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer commodo quam ac eros suscipit, vitae rhoncus risus vestibulum. Mauris at dapibus quam. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ut enim sodales, scelerisque libero quis, efficitur lorem. Curabitur et finibus nunc.','2019-03-25',1),(5,6,'test','2019-03-25',1),(6,6,'te','2019-03-25',1),(7,6,'tes','2019-03-25',1),(8,7,'hahaha','2019-04-04',1),(9,6,'tae','2019-04-08',2),(10,6,'asdasdasdasd','2019-04-08',1),(11,6,'tetet','2019-04-08',2);
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `user_feedbacks_view` AS select `user_feedbacks_table`.`userFeedbackId` AS `userFeedbackId`,`user_feedbacks_table`.`userId` AS `userId`,`user_feedbacks_table`.`userFeedback` AS `userFeedback`,`user_feedbacks_table`.`userFeedbackDate` AS `userFeedbackDate`,`user_feedbacks_table`.`userFeedbackStatus` AS `userFeedbackStatus`,`users_table`.`userEmail` AS `userEmail`,`users_table`.`userPassword` AS `userPassword`,`users_table`.`userFirstName` AS `userFirstName`,`users_table`.`userLastName` AS `userLastName`,concat(`users_table`.`userFirstName`,' ',`users_table`.`userLastName`) AS `userFullName`,`users_table`.`userAddress` AS `userAddress`,`users_table`.`userRegistrationDate` AS `userRegistrationDate`,`users_table`.`userPhoneNumber` AS `userPhoneNumber`,`users_table`.`userType` AS `userType`,`users_table`.`userIsBlocked` AS `userIsBlocked` from (`user_feedbacks_table` join `users_table` on((`user_feedbacks_table`.`userId` = `users_table`.`userId`))) where (`users_table`.`userIsBlocked` = 0) */;
