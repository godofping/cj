...
insert  into `administrators_table`(`administratorUserId`,`administratorUserName`,`administratorUserPassword`,`isDeleted`,`administratorfullName`) values (1,'admin','21232f297a57a5a743894a0e4a801fc3',0,'Admin Name'),(2,'user1','24c9e15e52afc47c225b757e7bee1f9d',1,'user1'),(3,'user2','7e58d63b60197ceb55a1c487989a3720',1,'user2'),(4,'user3','92877af70a45fd6a2ed7fe81e1236b78',1,'user3'),(5,'1','c4ca4238a0b923820dcc509a6f75849b',1,'1');
