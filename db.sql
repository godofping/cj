...
insert  into `administrators_table`(`administratorUserId`,`administratorEmail`,`administratorUserPassword`,`isDeleted`,`administratorFullName`,`isActivated`) values (1,'admin@gmail.com','21232f297a57a5a743894a0e4a801fc3',0,'Susan Lopez',1),(5,'jacobs123@gmail.com2','c81e728d9d4c2f636f067f89cc14862c',0,'Jacob Silang',0),(7,'josephmog23@gmail.com','245cf079454dc9a3374a7c076de247cc',0,'Joseph Moggins',0);
...
insert  into `order_details_table`(`orderDetailId`,`productVariationId`,`orderId`,`quantity`,`price`) values (48,49,48,1,288),(49,49,49,2,288),(50,60,50,1,165),(52,73,51,20,100),(53,57,52,4,398),(54,49,53,7,288),(55,49,54,1,288),(56,63,55,2,275);
...
insert  into `payments_table`(`paymentId`,`paymentAmount`,`orderId`,`paymentRecieptImage`,`paymentStatus`,`nameOfRemmitanceCenter`,`controlNumber`,`paymentTransactionDate`) values (76,'288',48,'','Recieved','','','2019-04-12 04:18:07'),(77,'576',49,NULL,'Recieved',NULL,NULL,'2019-04-12 04:45:38'),(78,'2000',51,NULL,'Recieved',NULL,NULL,'2019-04-12 18:14:19'),(79,'1592',52,'35fda6959e92d747b274fdf240bfa293images (2).png','Recieved','lbc','12345','2019-04-12 18:19:59'),(80,'288',54,'','Recieved','','','2019-04-15 10:11:46'),(81,'2016',53,'2b2f59b7db576155de9e3ae48c42b7321.jpg','Recieved','palawan','12534612','2019-04-15 15:28:45'),(82,'550',55,'ea0729819aa359c834df7817aa9e4a923.jpg','Recieved','asdads','asd','2019-04-18 00:34:42');
...
insert  into `user_feedbacks_table`(`userFeedbackId`,`userId`,`userFeedback`,`userFeedbackDate`) values (1,6,'test','2019-04-18');
